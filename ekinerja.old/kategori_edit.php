  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="box box-primary box-solid">
            ...
            <div class="box-body">
            <form method="post" action="kategori_editproses.php">
              <div class="box-body">
              <?php
	include 'koneksi.php';
    ...
    <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="id_kategori" name="id_kategori" value="<?php echo $d['id_kategori']; ?>">
                  </div>

              <div class="form-group">
                    <label for="user">Kategori</label>
                    <input value="<?php echo $d['kategori']; ?>" placeholder="Kategori" type="text" class="form-control" id="kategori" name="kategori">
                  </div>
...
<a class="btn btn-primary pull-left" href="kategori.php">Kembali</a>
                  <button type="submit" class="btn btn-primary pull-right">Ubah Kategori</button>
                </div>
                <?php
				}
				?>	
