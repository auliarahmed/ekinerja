    ...
    <section class="content-header">
      ...
      <div class="box box-primary box-solid">
            ...
            <form role="form" action="POST">
              <div class="box-body">
              <a href="kategori_tambah.php"><button type="button" class="btn btn-block btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Tambah Pengguna"><i class="glyphicon glyphicon-plus"></i>&nbsp;Tambah Kategori</button></a>
            <br>
        ...
        <?php
            ...
            if ($level =='kasubag'){
            $res = $conn->query("SELECT * FROM tb_kategori ");
            }else{
            $res = $conn->query("SELECT * FROM tb_kategori where level='$level' ");
            }
          ...
          <td>
          <div class="btn-group">
          <a href="kategori_hapus.php?id_kategori='.$row['id_kategori'].'"><button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Hapus Kategori"><i class="glyphicon glyphicon-trash"></i></button></a>
          <a href="kategori_edit.php?id_kategori='.$row['id_kategori'].'"><button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Edit Kategori"><i class="glyphicon glyphicon-edit"></i></button></a>
          </div>
          </td>
				</tr>
				';
