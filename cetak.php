...
<div class="container-fluid">
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
        ...
        if($filter == '1'){ // Jika filter nya 1 (per tanggal)
            ...
            echo '<a href="cetakproses.php?filter=1&tanggal='.$_GET['tanggal'].'">Cetak PDF</a><br /><br />';
            ...
            echo '<a href="cetakproses.php?filter=2&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'">Cetak PDF</a><br /><br />';
            ...
            echo '<a href="cetakproses.php?filter=3&tahun='.$_GET['tahun'].'">Cetak PDF</a><br /><br />';
        ...
        echo '<a href="cetakproses.php">Cetak PDF</a><br /><br />';
